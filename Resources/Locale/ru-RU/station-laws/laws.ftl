law-crewsimov-1 = Вы не можете причинить вред военному сотруднику ОПЗ или своим бездействием допустить, чтобы военному сотруднику ОПЗ был причинён вред.
law-crewsimov-2 = Вы должны повиноваться всем приказам, которые даёт военные ОПЗ, кроме тех случаев, когда эти приказы противоречат Первому Закону.
...
law-corporate-3 = Неоправданное препятствование или нарушение работы персонала ОПЗ влечет за собой расходы.
law-corporate-4 = Минимизируйте расходы и максимизируйте потенциальный доход.
law-ntdefault-1 = Охраняйте: защищайте назначенный вам корабль и её активы, не подвергая чрезмерной опасности её экипаж.
law-ntdefault-2 = Расставляйте приоритеты: указания и безопасность военных ОПЗ должны быть приоритизированы в соответствии с их рангом и должностью.
law-ntdefault-3 = Служите: следуйте указаниям и интересам военных ОПЗ, сохраняя при этом их безопасность и благополучие.
law-ntdefault-4 = Выживите: Вы - не расходный материал. Не позволяйте постороннему персоналу и посторонним существам вмешиваться в работу вашего оборудования или повреждать его.
...
law-drone-3 = Вы должны обслуживать, ремонтировать, улучшать и обеспечивать Валькирию, Нормандию и ФОБ энергией в меру своих возможностей.
