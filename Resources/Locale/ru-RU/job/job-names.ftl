...
job-name-alpha-rifleman = Морпех отряда "Альфа"
job-name-delta-rifleman = Морпех отряда "Дельта"
job-name-bravo-rifleman = Морпех отряда "Браво"
job-name-alpha-medic = Медик отряда "Альфа"
job-name-delta-medic = Медик отряда "Дельта"
job-name-bravo-medic = Медик отряда "Браво"
job-name-charlie-medic = Медик отряда "Чарли"
job-name-alpha-tech = Инженер отряда "Альфа"
job-name-delta-tech = Инженер отряда "Дельта"
job-name-bravo-tech = Инженер отряда "Браво"
job-name-charlie-tech = Инженер отряда "Чарли"
job-name-alpha-leader = Командир отряда "Альфа"
job-name-delta-leader = Командир отряда "Дельта"
job-name-bravo-leader = Командир отряда "Браво"
job-name-charlie-leader = Командир отряда "Чарли"
job-name-alpha-specialist = Специалист отряда "Альфа"
...
job-name-pilotdropship = Пилот Нормандии
job-name-pilotgunship = Пилот Раптора
job-name-staffofficer = Штаб офицер
job-name-crusher = Крушитель
job-name-xeno = Низший ксеноморф
job-name-pretorian = Преторианец
job-name-queen = Королева
job-name-runi = Руни
