...
ent-EncryptionKeyAlpha = alpha translator key
    .desc = An encryption key used by the Alpha.
ent-EncryptionKeyBravo = bravo translator key
    .desc = An encryption key used by the Bravo.
ent-EncryptionKeyCharlie = charlie translator key
    .desc = An encryption key used by the Charlie.
ent-EncryptionKeyDelta = delta translator key
    .desc = An encryption key used by the Delta.
ent-EncryptionKeyCommandMarine = Command's marine translator key
    .desc = An encryption key used by the Delta.
ent-EncryptionKeyHeadOperation = Head Operation marine translator key
    .desc = An encryption key used by the Delta.
